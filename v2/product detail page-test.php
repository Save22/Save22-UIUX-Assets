                        ...
                        <ol id="price-list" class="nolist group">
                            ...
                            <li class="group price-option">
                                <div class="price-header">
                                    ...
                                    <div class="store innercol">
                                        <a href="#"  data-reveal-id="mapModal" class="store-details" onclick="initialize();">Widget City Gadgets</a>
                                    </div>
                                </div>
                                <div class="group price-details">
                                    ...
                                    <div class="shop-more">
                                        ...
                                        <a href="store page.php"><span class="button radius">store details</span>
                                    </a>
                            ...
                            <li class="group price-option">
                                <div class="price-header">
                                    ...
                                    <div class="store innercol">
                                        <a href="#"  data-reveal-id="mapModal" class="store-details" onclick="initialize();">Accent Micro/SM City Marikina<br>
