  ...
  <div class="row">
    <div class="small-12 large-12 small-centered columns">
      ...
      <section>
        ...
        <p>maybe implement something like: <a href="http://blueimp.github.com/jQuery-File-Upload/">http://blueimp.github.com/jQuery-File-Upload/</a></p>
      </section>
    ...
    <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div>
                ...
                <button type="reset" class="button secondary cancel">
                    <i class="icon-ban-circle icon-white"></i>
                    <span>Cancel upload</span>
                </button>
                <button type="button" class="button secondary delete">
