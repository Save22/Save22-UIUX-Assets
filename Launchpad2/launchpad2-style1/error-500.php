...
<body>
  ...
  <div class="row main-row error-page error-404 min-height">
    <div class="small-12 columns">
      <section>
        <h1>Error 500</h1>
        <p>Oops, something went wrong with our server! We will look into it as soon as possible.</p>

        <p><strong>Meanwhile, you might want to check out these suggested places:</strong></p>
