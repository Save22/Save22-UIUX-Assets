...
<head>
  ...
  <style type="text/css">
    ...
    .top-bar-section.flipbook-extra-tabs a {
      font-weight: 300;
    }
...
<body>
  ...
  <header id="main-header" class="row" style="max-width: none;">
    <nav class="top-bar">
      ...
      <section class="top-bar-section flipbook-extra-tabs">
        <ul class="left">
          <li class="divider"></li>
          <li><a href="widgets/content-search.php" class="trigger-subcontent">Search Results for: Tissue paper</a></li>
          <li class="divider"></li>
          <li><a href="widgets/content-nearby.php" class="trigger-subcontent">What's Near</a></li>
          <li class="divider"></li>
          <li><a href="widgets/content-browse.php" class="trigger-subcontent">Browse</a></li>
          <li class="divider"></li>
        </ul>
      </section>
    </nav>
...
<script type="text/javascript">
  ...
  /* HEADER LINKS */
    ...
    var jContent = $( ".flipbook-subcontent" );
            
    // Hook up link click events to load content.
    $( ".trigger-subcontent" ).click(
      function( objEvent ){
        var jLink = $( this );
