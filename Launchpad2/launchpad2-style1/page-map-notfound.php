...
<div class="map-container">
  ...
  <div class="map-page" id="map">

  </div>

  <div class="row home-featured main-row home-content">
      <div class="row">
        <div class="small-12 large-12 columns loc-search error message">

          <h2>We're sorry. We couldn't find the location you were looking for. </h2>
          <p>Do you want to check out these suggested places instead? </p>

          <nav class="location-suggestions">
