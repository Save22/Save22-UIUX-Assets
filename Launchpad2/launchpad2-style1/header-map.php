...
<body>
            ...
            <form>
              <div class="row collapse wide">
                ...
                <div class="small-5 columns">
                  <a href="#" class="button">Search in Map</a>
                </div>
              </div>
            </form>
          </li>
  ...
  <div class="home-intro map-nav sub-header-nav row main-row fixed">
    <section class="top-bar-section">
      <ul>
          ...
          <form>
            <div class="row collapse">
              <div class="small-3 large-6 columns">
                <label class="inline loc-suggestions-trigger" for="header-location"><span class="left">Map Location </span> <img src="img/icon-loc.svg" alt="Change Location" class="right loc-icon"> </label>
              </div>
        ...
        <li class="map-category-filter"><a href="#" data-dropdown="drop1" class="drop-down-button">Promotion Categories: <span class="current">View All</span> <span class="arrow-down"></span></a></li>
      </ul>
