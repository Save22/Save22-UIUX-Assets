    ...
    <div class="small-12 large-8 columns">
      ...
      <section>
        <div class="promos-brands">
          <ul id="featured2" data-orbit data-options="bullets:false;stack_on_small: false;">
            <li data-orbit-slide="headline-1">
      ...
      <section>
          ...
          <ul class="small-block-grid-1 large-block-grid-3 home-featured-grid">
            <li class="item">
              <div class="cat-thumb">
                <a href="#">
                  <div class="thumb">
      ...
      <div class="row">
        <a href="main-more.php" class="button right">view more</a>
      </div>
      ...
      <section class="section section-links">
        ...
        <div class="row">
          <div class="small-12 large-3 columns">
            <h3>Gadgets</h3>
            <ul>
              <li><a href="#">Smartphones in Ortigas</a></li>
              <li><a href="#">Tablets in Ortigas</a></li>
              <li><a href="#">Laptops in Ortigas</a></li>
              <li><a href="#">Smartphone accessories in Ortigas</a></li>
            </ul>
          </div>
          <div class="small-12 large-3 columns">
            <h3>Groceries</h3>
